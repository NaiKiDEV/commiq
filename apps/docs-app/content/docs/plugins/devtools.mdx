...
| Classification | Events | Color |
| --- | --- | --- |
| Command | `commandStarted`, `commandHandled` | Indigo |
| Error | `commandHandlingError`, `invalidCommand` | Red |
| Interrupted | `commandInterrupted` | Orange |
| State change | `stateChanged` | Amber |
| Event | Custom events, `stateReset` | Green |
